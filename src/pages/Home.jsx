    ...
    return (
        <div className="min-h-screen w-full">
            ...
            <div className='flex flex-col justify-center items-center min-h-screen w-full text-white'>
                ...
                <img src="../assets/bithday.jpeg" alt="birthday" width={300} height={300 } className="rounded-xl h-auto w-1/2 md:w-1/3"/>
                <audio src="../assets/birthdaySong.mp3" autoPlay={true}></audio> 
